...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('thread_title', sa.String(), nullable=True),
    sa.Column('prompt_id', sa.Integer(), nullable=True),
    sa.Column('question_id', sa.Integer(), nullable=True),
    sa.Column('user_id', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    ...
    op.create_index(op.f('ix_thread_prompt_id'), 'thread', ['prompt_id'], unique=False)
    op.create_index(op.f('ix_thread_question_id'), 'thread', ['question_id'], unique=False)
    ...
    op.create_index('idx_user_assignment_selected_option_id', 'user_assignments', ['selected_option_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_user_assignment_selected_option_id', table_name='user_assignments')
    ...
    op.drop_index(op.f('ix_thread_question_id'), table_name='thread')
    op.drop_index(op.f('ix_thread_prompt_id'), table_name='thread')
